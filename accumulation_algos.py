...
@vastlogger.time_recorder
def learn_new_unknowns(args, operating_batch, rolling_models, probabilities_for_train_set, batch_no):
...
@vastlogger.time_recorder
def learn_new_unknowns_UDA_Thresh(args, operating_batch, rolling_models, probabilities_for_train_set, batch_no):
    if len(rolling_models.keys())==0:
        del probabilities_for_train_set[0]
        return operating_batch
    if batch_no==1:
        return learn_new_unknowns(args, operating_batch, rolling_models, probabilities_for_train_set, batch_no)
