...
experiments_combinations=("10 moco_v2_800ep_pretrain 2500" \
                          "10 MOCOv2_OpenImages 2500" \
                          "10 MOCOv2_Places 2500" \
                          "5 moco_v2_800ep_pretrain 1250" \
                          "5 MOCOv2_OpenImages 1250" \
                          "5 MOCOv2_Places 1250")
all_running_PIDS=()
exp_no=0
flag=-1

for exp_comb in "${experiments_combinations[@]}"; do
  read -r new_classes_per_batch feature_file unknown_sample_per_batch <<<$exp_comb
